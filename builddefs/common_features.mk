...
VALID_POINTING_DEVICE_DRIVER_TYPES := adns5050 adns9800 analog_joystick cirque_pinnacle_i2c cirque_pinnacle_spi paw3204 pmw3320 pmw3360 pmw3389 pimoroni_trackball ps2_trackpoint custom
ifeq ($(strip $(POINTING_DEVICE_ENABLE)), yes)
    ifeq ($(filter $(POINTING_DEVICE_DRIVER),$(VALID_POINTING_DEVICE_DRIVER_TYPES)),)
        ...
        ifeq ($(strip $(POINTING_DEVICE_DRIVER)), adns9800)
            ...
            LIB_SRC += analog.c
		else ifeq ($(strip $(POINTING_DEVICE_DRIVER)), ps2_trackpoint)
