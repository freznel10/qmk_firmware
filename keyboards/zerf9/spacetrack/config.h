...
#define EXTERNAL_EEPROM_SPI_CLOCK_DIVISOR    8//5
...
#define DISPLAY_CS_PIN_1_5_INCH_OLED_SSD1351 B12
#define DISPLAY_RST_PIN_1_5_INCH_OLED_SSD1351 A0
...
#define PS2_CLOCK_PIN B12
#define PS2_DATA_PIN B0
