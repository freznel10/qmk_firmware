...
const uint16_t PROGMEM pbleftl_combo[] = { PB_2, KC_MUTE, COMBO_END};
const uint16_t PROGMEM pbldnl_combo[] = { PB_3, KC_MUTE, COMBO_END};
const uint16_t PROGMEM pbrightl_combo[] = { PB_4, KC_MUTE, COMBO_END};
const uint16_t PROGMEM pbupr_combo[] = { PB_5, KC_MUTE, COMBO_END};
const uint16_t PROGMEM pbleftr_combo[] = { PB_6, KC_MUTE, COMBO_END};
const uint16_t PROGMEM pbldnr_combo[] = { PB_7, KC_MUTE, COMBO_END};
const uint16_t PROGMEM pbrightr_combo[] = { PB_8, KC_MUTE, COMBO_END};
...
combo_t key_combos[] = {
  ...
  [PD_SCROLL] = COMBO(dragscroll_combo, DRG_TOG),
  [PD_SNIPING] = COMBO(sniping_combo, SNP_TOG),
  ...
  [PBUP_L] = COMBO(pbupl_combo, LVGL_CONTROL_NEXT),
  [PBLEFT_L] = COMBO(pbleftl_combo, DPI_RMOD),
  [PBDOWN_L] = COMBO(pbldnl_combo, LVGL_ENCODER_BUTTON),
  [PBRIGHT_L] = COMBO(pbrightl_combo, DPI_MOD),
  [PBUP_R] = COMBO(pbupr_combo, KC_UP),
  [PBLEFT_R] = COMBO(pbleftr_combo, KC_LEFT),
  [PBDOWN_R] = COMBO(pbldnr_combo, KC_DOWN),
  [PBRIGHT_R] = COMBO(pbrightr_combo, KC_RIGHT)
