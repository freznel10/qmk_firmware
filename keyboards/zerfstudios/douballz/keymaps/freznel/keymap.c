...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_4x6_wrapper(
        ...
        _______,        _________________RAISE_L2__________________,                                                    _________________EXTEND_R2_________________,    KC_PIPE,
        _______,        _________________RAISE_L3__________________,    _______,                            _______,    _________________EXTEND_R3_________________,    _______,
                                                            _______,    _______,    _______,    _______,    _______,    _______,
                                                                        _______,    _______,    _______,    _______,
                                                            _______,    _______,    _______,    _______,    _______,    _______,
                                                            _______,    _______,                            _______,    _______
